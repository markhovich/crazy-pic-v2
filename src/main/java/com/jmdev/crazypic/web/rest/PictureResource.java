...
import com.jmdev.crazypic.repository.PictureRepository;
...
/**
 * REST controller for managing {@link com.jmdev.crazypic.domain.Picture}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Picture> result = pictureRepository
            ...
            .map(existingPicture -> {
                ...
                if (picture.getUrl() != null) {
                    existingPicture.setUrl(picture.getUrl());
                }
                if (picture.getPhotograph() != null) {
                    existingPicture.setPhotograph(picture.getPhotograph());
                }
                if (picture.getComment() != null) {
                    existingPicture.setComment(picture.getComment());
                }
                if (picture.getNbVotes() != null) {
                    existingPicture.setNbVotes(picture.getNbVotes());
                }
                if (picture.getNote() != null) {
                    existingPicture.setNote(picture.getNote());
                }
